            ...
            <Subscribe to={[OrderContainer]}>
                {orderContainer => (
                    <Modal 
                        ...
                        trigger={<Button color='orange' onClick={this.handleOpen}><Icon name='box'/> Fechar sacola</Button>}>
                        <Modal.Content>
                        <Modal.Description>
                            <Form>
                            <Form.Field>
                                <label>Entrega para:</label>
                                <Input placeholder='insira seu nome' onChange={(event, {value}) => orderContainer.setOrderOwner(value)}/>
                                <br/><br/>
                                <TextArea placeholder='Alguma observação ou detalhe do pedido aqui..' onChange={(event, {value}) => orderContainer.setOrderDetails(value)}/>
                            </Form.Field>
                            </Form>
                        </Modal.Description>
                        <br/>
                        <Modal.Actions>
                            ...
                            <Button
                                color='green'
                                disabled={
                                    !(orderContainer.state.bag.length != 0 && orderContainer.state.orderOwner &&
